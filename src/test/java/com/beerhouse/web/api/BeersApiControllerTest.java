...
import com.beerhouse.service.TestUtil;
...
//        final BeersApiController beersApiController = new BeersApiController(delegate);
//        this.mockMvc = MockMvcBuilders.standaloneSetup(beersApiController).build();
